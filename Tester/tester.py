...
tests_folder = r"/home/afonso/IA/projIA/Tester/Privado - Testes"
results_folder = r"/home/afonso/IA/projIA/Tester/Resultados"
bimaru_script = r"/home/afonso/IA/projIA/bimaru.py"
errors_in_tests = []
    ...
    if file_name.endswith(".txt") and not file_name.startswith("easy") and not file_name.startswith("medium"):
        ...
        # Compare the output file with the corresponding file in the tests folder
            ...
            if re.split(r'(\s+)', test_content) == re.split(r'(\s+)', output_content):
                pass # print(f"{file_name}: \t\tOutput respects the rules")
            else:
